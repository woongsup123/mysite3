...
<script>
	...
	$(function() {
		...
		$("#add-form").submit(function(event) {
			...
			if($("#input-name").val() ===''){
				//$( "#dialog-message" ).dialog();
				messageBox("메시지 등록", "이름이 비어 있습니다.",	"#input-name");
				return;
			}
			if($("#input-password").val() ===''){
				//$( "#dialog-message" ).dialog();
				messageBox("메시지 등록", "비밀번호가 비어 있습니다.", "#input-password");
				return;
			}
			if($("#tx-content").val() ===''){
				//$( "#dialog-message" ).dialog();
				messageBox("메시지 등록", "내용이 비어 있습니다.", "#tx-content");
				return;
			}
			var data = {};
